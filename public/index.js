...
function Slide(props) {
  return _react2.default.createElement(
    'div',
    { className: 'slide rel x' },
    _react2.default.createElement('img', { className: 'abs fill x',
      src: props.image })
  );
}
...
function Button(_ref) {
  var prev = _ref.prev,
      next = _ref.next,
      props = _objectWithoutProperties(_ref, ['prev', 'next']);

  return _react2.default.createElement(
    'button',
    _extends({}, props, { className: (0, _classnames2.default)('abs top bottom ma', {
        'prev': prev,
        'next': next
      }) }),
    _react2.default.createElement(
      'svg',
      { className: 'abs fill ma', viewBox: '0 0 16 16', width: '16', height: '16', fill: 'none', stroke: 'currentcolor', strokeWidth: '3' },
      _react2.default.createElement('path', { d: 'M5 1.0606601717798212 L11.939339828220179 8 L5 14.939339828220179' })
    )
  );
}
...
var Slider = function (_React$Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function componentDidMount() {
      this.slider = (0, _index2.default)(this.ref.current);
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'x rel', style: { overflow: 'hidden' } },
        _react2.default.createElement(
          'div',
          { ref: this.ref, className: (0, _classnames2.default)('slider rel', className) },
          children
        ),
        _react2.default.createElement(Button, { prev: true, onClick: function onClick(e) {
            return _this2.slider.prev();
          } }),
        _react2.default.createElement(Button, { next: true, onClick: function onClick(e) {
...
exports.default = ['https://format-com-cld-res.cloudinary.com/image/private/s--sRm2B9lw--/c_limit,g_center,h_65535,w_2500/a_auto,fl_keep_iptc.progressive,q_95/v1/f3586b2802e9ba2f64b85851103cdc3c/_DSC2366.jpg?2000', 'https://format-com-cld-res.cloudinary.com/image/private/s--2jiCi9e3--/c_limit,g_center,h_65535,w_2500/a_auto,fl_keep_iptc.progressive,q_95/v1/82bd6b7c7d7cc97cf83d2eeb36b155bc/_DSC2144.jpg?1766', 'https://format-com-cld-res.cloudinary.com/image/private/s--j-5qAuqU--/c_limit,g_center,h_65535,w_2500/a_auto,fl_keep_iptc.progressive,q_95/v1/5a39943bebe6d695ffd0b4c5d60b75dd/_DSC2300.jpg?1766', 'https://format-com-cld-res.cloudinary.com/image/private/s--0nuRXnBc--/c_limit,g_center,h_65535,w_2500/a_auto,fl_keep_iptc.progressive,q_95/v1/45d60ee306ae40574f10df5c1bfe1b2e/_DSC2202-3.jpg?1766', 'https://format-com-cld-res.cloudinary.com/image/private/s--p7_y_8zs--/c_limit,g_center,h_65535,w_2500/a_auto,fl_keep_iptc.progressive,q_95/v1/90c40a301a91880d177ffe4accb9fb04/_DSC1836.jpg?1766', 'https://format-com-cld-res.cloudinary.com/image/private/s--a5vxK5Hp--/c_limit,g_center,h_65535,w_2500/a_auto,fl_keep_iptc.progressive,q_95/v1/1bade1e3972676f5df2e64f6dfb8e339/_DSC1608-3.jpg?1766'];
...
function Slideshow(_ref) {
  ...
  return _react2.default.createElement(
    _Slider2.default,
    { className: className },
    _react2.default.createElement(_Slide2.default, { image: _images2.default[0] }),
    _react2.default.createElement(_Slide2.default, { image: _images2.default[1] }),
    _react2.default.createElement(_Slide2.default, { image: _images2.default[2] }),
    _react2.default.createElement(_Slide2.default, { image: _images2.default[3] }),
    _react2.default.createElement(_Slide2.default, { image: _images2.default[4] }),
    _react2.default.createElement(_Slide2.default, { image: _images2.default[5] })
  );
}
...
*/
var aa=__webpack_require__(3),ca=__webpack_require__(0),m=__webpack_require__(11),p=__webpack_require__(4),v=__webpack_require__(1),da=__webpack_require__(13),ea=__webpack_require__(16),fa=__webpack_require__(12),ha=__webpack_require__(2);
...
/* harmony export (immutable) */ __webpack_exports__["default"] = noodle;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tinkerbell__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rosin__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_mitt__ = __webpack_require__(20);
...
function noodle (slider, opts = {}) {
   ...
   * Events
   */
  const ev = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_mitt__["a" /* default */])()
  ...
  function selectByIndex () {
    ...
    tick = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_tinkerbell__["a" /* default */])(prev, next, 1000, ease)(v => {
  ...
  const drag = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_rosin__["a" /* default */])(slider)
...
"use strict";
var e=Math.abs;function n(e,n){return e.touches?e.touches[0][n?"pageY":"pageX"]:e[n?"clientY":"clientX"]}/* harmony default export */ __webpack_exports__["a"] = (function(t){var o,r,i,d=!1,u=!1,w={};function a(e){(e.target===t||t.contains(e.target))&&(e.preventDefault(),d=!0,r=n(e),i=n(e,1),c("mousedown",{x:r,y:i},e))}function s(e){d&&(c("mouseup",e),u?c("dragEnd",e):c("tap",{x:r,y:i},e)),f()}function v(t){if(d){t.preventDefault();var w=n(t)-r,a=n(t,1)-i,s=e(w),v=e(a),f=s>v,m={x:w,y:a};if(s<10&&v<10)return;u=!0,c("drag",m,t),w>0&&f?(c("dragRight",m,t),"right"!==o&&(c("right",{x:r,y:i},t),o="right")):w<0&&f?(c("dragLeft",m,t),"left"!==o&&(c("left",{x:r,y:i},t),o="left")):a>0&&!f?(c("dragDown",m,t),"down"!==o&&(c("down",{x:r,y:i},t),o="down")):a<0&&!f&&(c("dragUp",m,t),"up"!==o&&(c("up",{x:r,y:i},t),o="up"))}}function c(e,n,t){if(w[e])for(var o=0;o<w[e].length;o++)w[e][o](n,t)}function f(){o=null,r=null,i=null,d=!1}return window.addEventListener("mousedown",a),window.addEventListener("touchstart",a),window.addEventListener("mouseup",s),window.addEventListener("touchend",s),window.addEventListener("mousemove",v),window.addEventListener("touchmove",v),window.addEventListener("touchcancel",f),{on:function(e,n){return w[e]=w[e]||[],w[e].indexOf(n)<0&&w[e].push(n),function(){return w[e].splice(w[e].indexOf(n),1)}},destroy:function(){window.removeEventListener("mousedown",a),window.removeEventListener("touchstart",a),window.removeEventListener("mouseup",s),window.removeEventListener("touchend",s),window.removeEventListener("mousemove",v),window.removeEventListener("touchmove",v),window.removeEventListener("touchcancel",f)}}});;
//# sourceMappingURL=rosin.es.js.map
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function(n,t,r,u){return function(e,i){var o,a,c,f;return c=function m(d){return requestAnimationFrame(function(l){a||(a=l),o=l-a,f=Math.round(u(o,n,t-n,r)),(t>n?f<t&&d<=t:f>t&&d>=t)&&o<=r?(c=m(f),e(f)):(e(t),i&&i())})}(n),function(){cancelAnimationFrame(c)}}});;
